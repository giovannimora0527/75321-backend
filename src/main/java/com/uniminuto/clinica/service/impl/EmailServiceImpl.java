...
public class EmailServiceImpl implements EmailService {
    ...
    //Inyectamos  para manejar el correo
    private final JavaMailSender mailSender;

    private final EmailConfig emailConfig;

    @Override
    public void enviarCorreoSimple(String to, String subject, String body) throws BadRequestException {
        try {
    ...
    @Override
    public void enviarCorreo(String to, String subject, String body, String from) throws BadRequestException, MessagingException {
